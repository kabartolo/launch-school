...
# In the previous 3 exercises, you developed methods called any?, all?, 
# and none? that are similar to the standard Enumerable methods of the same
# names. In this exercise, you will develop one last method from this family, 
# one?.
...
# take an Array as an argument, and a block. It should return true if the block 
# returns true for exactly one of the element values. Otherwise, it should return 
# false.

# Your method should stop processing elements of the Array as soon as the 
# block returns true a second time.

# If the Array is empty, one? should return false, regardless of how the 
# block is defined.
