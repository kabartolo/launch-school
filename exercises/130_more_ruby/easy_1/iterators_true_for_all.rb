...
# the block returns a value of true for every element, then #all?
# returns true. Otherwise, #all? returns false. Note in particular
# that #all? will stop searching the collection the first time the
# block returns false.
...
# true if the block returns true for all of the element values.
# Otherwise, it should return false.

# Your method should stop processing elements of the Array as soon
# as the block returns false.

# If the Array is empty, all? should return true, regardless of how
