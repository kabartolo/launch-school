...
# The Enumberable#max_by method iterates over the members
# of a collection, passing each element to the associated
# block. It then returns the element for which the block
# returned the largest value.

# Write a method called max_by that behaves similarly for
# Arrays. It should take an Array and a block, and return
