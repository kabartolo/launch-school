...
def longest_paragraph(text)
  text.split(/\n\n/).map { |paragraph| paragraph.split(' ').size }.max
end

p longest_paragraph(text)

def longest_word(text)
  text.split(' ').map { |word| word.length }.max
end
