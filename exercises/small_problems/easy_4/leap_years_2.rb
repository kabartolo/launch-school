# Easy 4: Exercise 4: Leap Years (Part 2) (6 April 2017)

# A continuation of the previous exercise.

# The British Empire adopted the Gregorian Calendar in
# 1752, which was a leap year. Prior to 1752, the Julian
# Calendar was used. Under the Julian Calendar, leap years
...
puts leap_year?(1700) == true # false under Gregorian rules
puts leap_year?(1) == false
puts leap_year?(100) == true # false under Gregorian rules
