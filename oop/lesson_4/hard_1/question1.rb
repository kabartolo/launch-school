...
# of the class attempt to access the secret data. Here is the
...
# SecretFile to have an instance of SecurityLogger be passed
# in as an additional argument. It may be helpful to review the
# lecture on collaborator objects for this exercise.
...
crush_logger = SecurityLogger.new
secrets = SecretFile.new("I like Steve.", crush_logger)